...
ALGORITHM_CHOICES = ("huang2022", "izumi2026", "izumi2026_handoff", *RSKL_ALGORITHMS)
...
def main() -> None:
    ...
    for trial in range(config.trials):
        ...
        for izumi_name in [a for a in ("izumi2026", "izumi2026_handoff") if a in algorithms]:
            for n in config.n_values:
                if izumi_name == "izumi2026_handoff" and n == 1:
