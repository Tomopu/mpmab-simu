...
_ALGORITHM_LABELS = {
    ...
    "trinh2021_rskl": "Randomized Selfish KL-UCB (c=0)",
    "trinh2021_rskl_c3": "Randomized Selfish KL-UCB (authors' code, c=3)",
}
...
_FIXED_STYLES: Dict[str, Dict] = {
    ...
    "trinh2021_rskl_c3": dict(color="#9a6b2f", linestyle=":", linewidth=2.5, zorder=5),
}
